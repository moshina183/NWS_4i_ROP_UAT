...
public class TrafficInformationEntitiesWsProviderTrafficInformationASE extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Moshina/NWS-ROPservices/src/main/resources/wsdl/trafficUAT.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TrafficInformationEntitiesWsProviderTrafficInformationASE.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Moshina/NWS-ROPservices/src/main/resources/wsdl/trafficUAT.wsdl");
        }
        WSDL_LOCATION = url;
    }
